...
pub async fn food_offer(pool: &MySqlPool, offer_id: u64) -> anyhow::Result<FoodOffer> {
...
pub async fn buff_offer(pool: &MySqlPool, buff_id: u64) -> anyhow::Result<BuffOffer> {
...
pub async fn offer(pool: &MySqlPool, offer_type: OfferType, item_id: u64) -> anyhow::Result<Offer> {
    Ok(match offer_type {
